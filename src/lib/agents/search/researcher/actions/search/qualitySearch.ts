...
import { searchAndEmit } from './searchHelpers';
...
const extractorPrompt = `
      ...
      5. Duplicate information: If a fact appears multiple times (e.g., in a paragraph and in a technical table), merge the details into a single, high-density bullet point to avoid redundancy.
...
export const executeQualitySearch = async (
  input: {
    queries: string[];
